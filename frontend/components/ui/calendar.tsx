...
function Calendar({
    ...
    return (
        <div className={className}>
            <style>{`
                .rdp-head_row, .rdp-head, thead { display: none !important; }
            `}</style>
            <DayPicker
                locale={fr}
                showOutsideDays={showOutsideDays}
                className={cn("p-3 relative")}
                classNames={{
                    ...
                    head_row: "flex",
                    head_cell: "text-muted-foreground bg-slate-100/50 rounded-md w-9 font-medium text-[0.8rem] h-9 flex items-center justify-center m-0.5",
