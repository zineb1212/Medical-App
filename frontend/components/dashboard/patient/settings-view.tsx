...
export function SettingsView() {
    ...
    const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (res.ok) {
                const data = await res.json()
                // Update local state temporarily, will be saved on "Save" or auto-save?
                // Let's auto-save avatar url
    ...
    return (
        <div className="space-y-6 max-w-2xl mx-auto">
            <div className="rounded-2xl bg-gradient-to-r from-primary to-primary/80 p-6 text-primary-foreground">
                ...
                <p className="mt-1 text-primary-foreground/80">Gérer vos informations personnelles</p>
            </div>
